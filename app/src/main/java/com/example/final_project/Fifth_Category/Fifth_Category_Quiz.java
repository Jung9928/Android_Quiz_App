...
public class Fifth_Category_Quiz extends AppCompatActivity {
    String title;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DocumentReference doc = database.collection("Fifth_Category_Quiz").document("Fifth_Category_Pr" + count);
