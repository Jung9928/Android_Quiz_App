package com.example.final_project.Third_Category;
...
public class Third_Category_Quiz extends AppCompatActivity {
    String title;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DocumentReference doc = database.collection("Third_Category_Quiz").document("Third_Category_Pr" + count);
