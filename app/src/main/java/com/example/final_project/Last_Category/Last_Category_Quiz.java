...
public class Last_Category_Quiz extends AppCompatActivity {
    String title;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DocumentReference doc = database.collection("2020y_First_Second_Quiz").document("First_Second_Pr" + count);
