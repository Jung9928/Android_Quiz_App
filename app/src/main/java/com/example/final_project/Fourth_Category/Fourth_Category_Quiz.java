package com.example.final_project.Fourth_Category;
...
public class Fourth_Category_Quiz extends AppCompatActivity {
    String title;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DocumentReference doc = database.collection("Fourth_Category_Quiz").document("Fourth_Category_Pr" + count);
